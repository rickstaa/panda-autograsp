"""
Script to register a kinect sensor to a chessboard for the Emika franka setup

.. Note:: Based on the register_camera.py script of the `berkeleyautomation/perception module <https://www.github.com/berkeleyautomation/perception>`_.
"""
...
## Berkeleyautomation module imports ##
...
## Setup logger ##
main_logger = logging.getLogger("CameraCalibration")
...
#################################################
## Clicked point retreiver function #############
#################################################
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', type=str, default=CAMERA_CALIB_CFG, help='filename of a YAML configuration for registration')
    ...
    for sensor_frame, sensor_data in config['sensors'].iteritems():
        ...
        if config['fix_orientation_cb_to_world']:
            ...
            for robot_pose in robot_poses:
                ...
                clicked_pt =cv2.setMouseCallback('click', click_gripper)
                while True:
